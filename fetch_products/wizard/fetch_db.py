...
class FetchDBWiazrd(models.TransientModel):
    ...
    db_one = fields.Char(string="Database One",
                         help="Database from the products transfers")
    db_one_username = fields.Char(string="Username")
    db_one_password = fields.Char(string="Password")
    db_two = fields.Char(string="Database Two",
                         help="Database to the products receives")
    db_two_username = fields.Char(string="Username")
    db_two_password = fields.Char(string="Password")
